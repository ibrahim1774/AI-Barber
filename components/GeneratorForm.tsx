...
import { isBooksyPath, isFreeBarberPath, isBookingPath, isHome2Path, isHome15Path, isHome20Path, isHome7Path, isHome9Path, isCustomDesignPath } from '../lib/dealMode.ts';
