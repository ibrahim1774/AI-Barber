...
export const HomeLaunchGuide: React.FC<HomeLaunchGuideProps> = ({ onClose }) => {
  // Every path leads with the publish CTA again, the homepage included
  // (owner, 2026-09-21 — it was custom-only between 09-13 and 09-21).
  // Name the button the visitor actually sees.
  return (
    <div
